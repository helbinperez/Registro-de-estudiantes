...
namespace RegistroEstudiantes.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(RegistroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellidos,Estatus,Carrera")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellidos,Estatus,Carrera")] Estudiante estudiante)
        {
